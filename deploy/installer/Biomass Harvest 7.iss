...
Source: {#BuildDir}\Landis.Extension.BiomassHarvest-v7.dll; DestDir: {#ExtDir}; Flags: ignoreversion

; Requisite auxiliary libraries
; NB. These libraries are used by other extensions and thus are never uninstalled.
Source: {#BuildDir}\Landis.Library.BiomassHarvest-v4.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall ignoreversion
...
#define InfoTxt "Biomass Harvest 7.txt"
