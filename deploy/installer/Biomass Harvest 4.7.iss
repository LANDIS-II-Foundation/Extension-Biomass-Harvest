...
Source: {#BuildDir}\Landis.Extension.BiomassHarvest-v4.7.dll; DestDir: {#ExtDir}; Flags: ignoreversion
...
Source: {#BuildDir}\Landis.Library.BiomassHarvest-v3.3.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall ignoreversion
...
Source: {#BuildDir}\Landis.Library.HarvestManagement-v4.2.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall ignoreversion
Source: {#BuildDir}\Landis.Library.Metadata-v2.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall ignoreversion
Source: {#BuildDir}\Landis.Library.SiteHarvest-v2.1.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall ignoreversion
...
#define InfoTxt "Biomass Harvest 4.7.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Biomass Harvest v4.7"" "; WorkingDir: {#LandisPlugInDir}
